...
class NsfIntegrate60(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Ra_Integrate_1 = ra_integrate.ra_integrate('Watch60.not', observer, fftsize, Frequency, Bandwidth, Azimuth, Elevation, Record, obstype, (4**5), units, 295., 10.)
        self.Ra_Ascii_Sink_0 = ra_ascii_sink.ra_ascii_sink('Watch60.not', observer, fftsize, Frequency, Bandwidth, Azimuth, Elevation, Record, 
